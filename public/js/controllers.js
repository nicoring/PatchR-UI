...
angular.module('PatchR-app.controllers', [])
    .controller('aboutController', function($scope) {
        window.document.title = "PatchR - About";

    })
    .controller('tableController', function($scope, $filter, $http, ngTableParams) {
...
//        $scope.loadData();
    ...
    .controller('statisticController', function($scope, $http) {
...
//        })
    ...
    .controller('ontologyController', function($scope) {
